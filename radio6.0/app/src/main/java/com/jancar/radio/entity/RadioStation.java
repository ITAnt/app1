...
public class RadioStation{
    ...
    @Generated(hash = 1628308261)
    public RadioStation(Long _id, String desp, int id, int isLove, int kind,
            int mBand, int mFreq, String name, int position, String rdsname,
            boolean select, int frequency, int Location) {
        this._id = _id;
        this.desp = desp;
        this.id = id;
        this.isLove = isLove;
