...
public class CheckPhoneUtil {
    ...
    public static String getNumberOperator(String number) {
        String returnString = "未知号码";
        if (isPhoneNum(number)) {
            if (isChinaMobilePhoneNum(number)) {
                returnString = "中国移动";
            }
            if (isChinaTelecomPhoneNum(number)) {
                returnString = "中国电信";

            }
            if (isChinaUnicomPhoneNum(number)) {
                returnString = "中国联通";
            }
        }
        return returnString;
    ...
    public static boolean CheckPhoneNum(String keyword) {
