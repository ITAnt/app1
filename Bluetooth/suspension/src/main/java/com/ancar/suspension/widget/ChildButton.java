...
/**
 * A simple button implementation with a similar look an feel to{@link FloatingButton}.
 */
public class ChildButton extends FrameLayout {
    ...
    public ChildButton(Context context, LayoutParams layoutParams, int theme, Drawable backgroundDrawable, View contentView, LayoutParams contentParams) {
        super(context);
    ...
    /**
     * A builder for {@link ChildButton} in conventional Java Builder format
     */
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            setTheme(ChildButton.THEME_LIGHT);
        }
        ...
        public ChildButton build() {
            return new ChildButton(context,
                    layoutParams,
                    theme,
                    backgroundDrawable,
                    contentView,
