...
public class FloatingButton extends FrameLayout {
    ...
    /**
     * Constructor that takes parameters collected using {@link FloatingMenu.Builder}
     ...
     * @param contentParams
     */
    public FloatingButton(Context context, ViewGroup.LayoutParams layoutParams, int theme,
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            setTheme(FloatingButton.THEME_LIGHT);
            setPosition(FloatingButton.POSITION_BOTTOM_RIGHT);
