...
public class SwitchButton extends CompoundButton implements AnimatorListener {
	...
	private void init(AttributeSet attrs) {
		...
		mProcessAnimator.addListener(this);
	...
	private void setup() {
		...
		if (mIsBackUseDrawable && mBackDrawable.getMinimumWidth() > mThumbSizeF.x) {
			mBackRectF.set(backLeft, mThumbRectF.top - mThumbMargin.top,
					backLeft + mThumbMargin.left + mBackDrawable.getMinimumWidth() + mThumbMargin.right,
	...
	public void onAnimationEnd(Animator animation) {
		...
		float process = (Float) animator.getAnimatedValue("process");
		if (process == 0) {
