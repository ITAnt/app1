...
public class RadioPresenter extends BaseModelPresenter<RadioContract.View, RadioModel> implements RadioContract.Presenter, RadioModel.Callback {
    ...
    @Override
    public void initText(int Band, int mLocation) {
        getUi().initText(getModel().initText(Band, mLocation));
    ...
    public void Replace(RadioStation radioStations, RadioStation radioStation) {
        ...
        getUi().initText(getModel().initText(radioStations.getFrequency(), radioStations.getLocation()));
        //initText();
    }

    @Override
    public void select(int i, Integer tag, int mLocation) {

        getUi().initSelect(getModel().initText(tag, mLocation), getModel().select(i, tag, mLocation));
    }
    ...
    @Override
    public void save(ArrayList<RadioStation> mScanResultList, int mBand, int Band, int mLocation) {
