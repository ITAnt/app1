...
public class RuleView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        indicatorLineColor = ta.getColor(R.styleable.RuleView_zjun_indicatorLineColor, Color.parseColor("#0048b975"));
    ...
    private void init(Context context) {
        ...
        mPaints.setStrokeWidth(shortLineWidth);
    ...
    private int calculateSize(boolean isWidth, int spec) {
        ...
        switch (mode) {
            ...
            case MeasureSpec.AT_MOST:
                if (!isWidth) {
                    int defaultContentSize = dp2px(60);
...
/*        if (mScroller.computeScrollOffset()) {
    ...
    private void drawGradation(Canvas canvas) {
        ...
        mPaints.setColor(Color.parseColor("#0068B7"));
        mPaint.setStrokeWidth(shortLineWidth);
        mPaints.setStrokeWidth(shortLineWidth);
        ...
        while (startNum <= rightMaxNum) {
            ...
            if ((b ? startNum / 10 : startNum) % numberPerCount == 0) {
                ...
                canvas.drawLine(distance, 10, distance, longGradationLen, mPaints);
                ...
                // 短刻度
                mPaint.setStrokeWidth(shortLineWidth);
                canvas.drawLine(distance, 20, distance, shortGradationLen, mPaint);
            }
     ...
     */
    public void setValue(float minValue, float maxValue, float curValue, float unit, int perCount, boolean b, boolean d) {
